...
interface Command {
    ...
    enum class Basic(
        ...
        CC_CRMVIEW_SETTEXTFONT(listOf(INT, FONTMETRICS), listOf(), true),
        ...
        IF_CRMVIEW_SETTEXTFONT(listOf(INT, FONTMETRICS, COMPONENT), listOf()),
        ...
        NC_MINIMENUNAME(listOf(NPC, INT, BOOLEAN), listOf(STRING)),
        NC_MINIMENUOP(listOf(NPC, INT, BOOLEAN), listOf(STRING)),
        ...
        LC_MINIMENUNAME(listOf(LOC, BOOLEAN), listOf(STRING)),
        LC_MINIMENUOP(listOf(LOC, INT, BOOLEAN), listOf(STRING)),
        ...
        OC_MINIMENUNAME(listOf(OBJ, BOOLEAN), listOf(STRING)),
        OC_MINIMENUOP(listOf(OBJ, INT, BOOLEAN), listOf(STRING)),
        ...
        STRINGVECTOR_CONTAINS(listOf(STRINGVECTOR, STRING, BOOLEAN, BOOLEAN), listOf(INT)),
