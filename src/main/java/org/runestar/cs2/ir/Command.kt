...
interface Command {
    ...
    enum class Basic(
        ...
        CC_SETTEXTFONT(listOf(GRAPHIC), listOf(), true),
        ...
        CC_SETGRADIENTMODE(listOf(INT), listOf(), true),
        ...
        CC_CRMVIEW_SETURL(listOf(STRING), listOf(), true),
        CC_CRMVIEW_SETTEXTFONT(listOf(INT, GRAPHIC), listOf(), true),
        CC_CRMVIEW_SETSERVERTARGETS(listOf(STRING, INT), listOf(), true),
        CC_INPUT_SETSELECTCOLOUR(listOf(COLOUR), listOf(), true),
        CC_INPUT_SETSELECTBGCOLOUR(listOf(COLOUR), listOf(), true),
        CC_INPUT_SETWIDTH(listOf(INT), listOf(), true),
        CC_INPUT_SETLINECOUNTLIMIT(listOf(INT), listOf(), true),
        CC_INPUT_SETLINEWIDTHLIMIT(listOf(INT), listOf(), true),
        CC_INPUT_SETFOCUS(listOf(BOOLEAN), listOf(), true),
        CC_INPUT_SETCARET(listOf(INT), listOf(), true),
        ...
        CC_SETPINCH(listOf(BOOLEAN), listOf(), true),
        ...
        CC_GETGRADIENTMODE(listOf(), listOf(INT), true),
        CC_GETMODELTRANSPARENT(listOf(), listOf(BOOLEAN), true),
        CC_GETARCSTART(listOf(), listOf(INT), true),
        CC_GETARCEND(listOf(), listOf(INT), true),
        CC_INPUT_GETFOCUS(listOf(), listOf(BOOLEAN), true),

        CC_GETINVOBJECT(listOf(), listOf(OBJ), true),
        CC_GETINVCOUNT(listOf(), listOf(COUNT), true),
        CC_GETID(listOf(), listOf(COMSUBID), true),
        CC_CRMVIEW_GETHASRESPONSE(listOf(), listOf(BOOLEAN), true),
        CC_CRMVIEW_GETINT(listOf(STRING), listOf(INT), true),
        CC_CRMVIEW_GETSTRING(listOf(STRING), listOf(STRING), true),
        ...
        IF_SETTEXTFONT(listOf(GRAPHIC, COMPONENT), listOf()),
        ...
        IF_SETGRADIENTMODE(listOf(INT, COMPONENT), listOf()),
        ...
        IF_CRMVIEW_SETURL(listOf(STRING, COMPONENT), listOf()),
        IF_CRMVIEW_SETTEXTFONT(listOf(INT, GRAPHIC, COMPONENT), listOf()),
        IF_CRMVIEW_SETSERVERTARGETS(listOf(STRING, INT, COMPONENT), listOf()),
        ...
        IF_SETPINCH(listOf(BOOLEAN, COMPONENT), listOf()),
        ...
        IF_INPUT_GETFOCUS(listOf(COMPONENT), listOf(BOOLEAN)),
        ...
        IF_CRMVIEW_GETHASRESPONSE(listOf(COMPONENT), listOf(BOOLEAN)),
        IF_CRMVIEW_GETINT(listOf(STRING, COMPONENT), listOf(INT)),
        IF_CRMVIEW_GETSTRING(listOf(STRING, COMPONENT), listOf(STRING)),
        ...
        SETCLICKGRAPHIC(listOf(GRAPHIC, BOOLEAN), listOf()),
        _3131(listOf(BOOLEAN), listOf()),
        ...
        NOTIFICATIONS_SENDLOCAL(listOf(STRING, STRING, INT, INT), listOf(INT)),
        MARKETING_INITANALYTICS(listOf(), listOf()),
        MARKETING_SENDANALYTICSEVENT(listOf(STRING), listOf()),
        MARKETING_INITATTRIBUTION(listOf(), listOf()),
        MARKETING_SENDATTRIBUTIONEVENT(listOf(STRING), listOf()),
        SETBRIGHTNESS(listOf(INT), listOf()),
        GETBRIGHTNESS(listOf(), listOf(INT)),
        SETANTIDRAG(listOf(BOOLEAN), listOf()),
        _3184(listOf(INT), listOf()),
        SEQ_PREFETCH(listOf(SEQ), listOf()),
        ...
        IDLETIMER_GET(listOf(), listOf(INT)),
        IDLETIMER_RESET(listOf(), listOf()),
        DESTINATIONCOORD(listOf(), listOf(_COORD)),
        RUNENERGY(listOf(), listOf(INT)),

        ENUM_STRING(listOf(_ENUM, INT), listOf(STRING)),
        ENUM_GETOUTPUTCOUNT(listOf(_ENUM), listOf(COUNT)),

        KEYHELD(listOf(KEY), listOf(BOOLEAN)),
        KEYPRESSED(listOf(KEY), listOf(BOOLEAN)),
        ...
        OC_STOCKMARKET(listOf(OBJ), listOf(BOOLEAN)),
        OC_STOCKMARKETVALUE(listOf(OBJ), listOf(INT, INT)),
        ...
        PARSEINT(listOf(STRING), listOf(INT)),
        ...
        TEXT_PRONOUN(listOf(STRING, STRING, STRING), listOf(STRING), true),
        PRONOUN(listOf(), listOf(INT), true),
        ...
        UIZOOM_SET(listOf(INT), listOf()),
        UIZOOM_RESET(listOf(), listOf()),
        SAFEAREA_GETMINX(listOf(), listOf(INT)),
        SAFEAREA_GETMINY(listOf(), listOf(INT)),
        SAFEAREA_GETMAXX(listOf(), listOf(INT)),
        SAFEAREA_GETMAXY(listOf(), listOf(INT)),
        _6230(listOf(INT), listOf()),
        SIDEBAR_SETWIDTH(listOf(INT, INT), listOf()),
        SIDEBAR_CLEARWIDTH(listOf(BOOLEAN), listOf()),
        ...
        NPC_CREATIONCYCLE(listOf(), listOf(INT)),
        NPC_TYPE(listOf(), listOf(NPC)),
        NC_NAME(listOf(NPC), listOf(STRING)),
        NPC_FINDUID(listOf(_NPC_UID), listOf(BOOLEAN)),
        NPC_GETOPBASE(listOf(INT, BOOLEAN), listOf(STRING)),
        NPC_GETOP(listOf(INT, BOOLEAN), listOf(STRING)),
        NC_GETOPBASE(listOf(NPC, INT, BOOLEAN), listOf(STRING)),
        NC_GETOP(listOf(NPC, INT, BOOLEAN), listOf(STRING)),
        ...
        LC_GETOPBASE(listOf(LOC, BOOLEAN), listOf(STRING)),
        LC_GETOP(listOf(LOC, INT, BOOLEAN), listOf(STRING)),
        ...
        OBJ_FIND(listOf(_COORD, OBJ), listOf(BOOLEAN)),
        OC_GETOPBASE(listOf(OBJ, BOOLEAN), listOf(STRING)),
        OC_GETOP(listOf(OBJ, INT, BOOLEAN), listOf(STRING)),
        OBJ_FINDBYINDEX(listOf(_COORD, INT), listOf(BOOLEAN)),
        ...
        PLAYER_ROUTE_LENGTH(listOf(), listOf(INT)),
        PLAYER_ROUTE_GET(listOf(INT), listOf(_COORD)),
        UID(listOf(), listOf(_PLAYER_UID)),
        SELF_PLAYER_UID(listOf(), listOf(_PLAYER_UID)),

        TILE_COORD(listOf(), listOf(_COORD)),
        TILE_FIND(listOf(_COORD), listOf(BOOLEAN)),
        ...
        HIGHLIGHT_PLAYER_GET(listOf(STRING, INT), listOf(BOOLEAN)),
        ...
        HIGHLIGHT_GROUP_SETUP(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        HIGHLIGHT_GROUP_ON(listOf(STRING, INT), listOf()),
        HIGHLIGHT_GROUP_OFF(listOf(STRING, INT), listOf()),
        HIGHLIGHT_GROUP_GET(listOf(STRING, INT), listOf(BOOLEAN)),
        HIGHLIGHT_GROUP_CLEAR(listOf(INT), listOf()),
        ...
        COORD_FIND_ACTIVE_MINIMENU_ENTRY(listOf(), listOf(_COORD)),
        _7107(listOf(), listOf(INT)),
        GET_MINIMENU_OPENED(listOf(), listOf(BOOLEAN)),
        ...
        ENTITYOVERLAY_CREATE_NPC(listOf(INT, INT, X, Y, INT), listOf(ENTITYOVERLAY)),
        ENTITYOVERLAY_CREATE_LOC(listOf(INT, INT, X, Y, INT), listOf(ENTITYOVERLAY)),
        ENTITYOVERLAY_CREATE_PLAYER(listOf(INT, INT, X, Y, INT), listOf(ENTITYOVERLAY)),
        ENTITYOVERLAY_CREATE_COORD(listOf(_COORD, INT, INT, X, Y, INT), listOf(ENTITYOVERLAY)),
        ENTITYOVERLAY_GET_NPC(listOf(INT), listOf(ENTITYOVERLAY)),
        ENTITYOVERLAY_GET_LOC(listOf(INT), listOf(ENTITYOVERLAY)),
        ENTITYOVERLAY_GET_PLAYER(listOf(INT), listOf(ENTITYOVERLAY)),
        ENTITYOVERLAY_GET_COORD(listOf(_COORD, INT), listOf(ENTITYOVERLAY)),
        ...
        STRINGVECTOR_ADD(listOf(STRINGVECTOR, STRING), listOf()),
        STRINGVECTOR_ADDUNIQUE(listOf(STRINGVECTOR, STRING, BOOLEAN), listOf()),
        STRINGVECTOR_INSERT(listOf(STRINGVECTOR, INT, STRING), listOf()),
        STRINGVECTOR_SET(listOf(STRINGVECTOR, INT, STRING), listOf()),
        STRINGVECTOR_REMOVE(listOf(STRINGVECTOR, STRING, BOOLEAN), listOf()),
        STRINGVECTOR_REMOVEAT(listOf(STRINGVECTOR, INT), listOf()),
        STRINGVECTOR_GET(listOf(STRINGVECTOR, INT), listOf(STRING)),
        STRINGVECTOR_SIZE(listOf(STRINGVECTOR), listOf(INT)),
        STRINGVECTOR_CONTAINS(listOf(STRINGVECTOR, STRING, BOOLEAN, BOOLEAN), listOf(BOOLEAN)),
        STRINGVECTOR_CLEAR(listOf(STRINGVECTOR), listOf()),
        MINIMENU_SIZE(listOf(), listOf(INT)),
        MINIMENU_TYPE(listOf(INT), listOf(MINIMENU_ENTRY_TYPE)),
        MINIMENU_NPC_FIND(listOf(INT), listOf(BOOLEAN)),
        MINIMENU_LOC_FIND(listOf(INT), listOf(BOOLEAN)),
        MINIMENU_OBJ_FIND(listOf(INT), listOf(BOOLEAN)),
        MINIMENU_PLAYER_FIND(listOf(INT), listOf(BOOLEAN)),
        MINIMENU_COORD(listOf(INT), listOf(_COORD)),
        MINIMENU_COMPONENT_FIND(listOf(INT), listOf(BOOLEAN)),
        _7460(listOf(), listOf(INT)),
        _7462(listOf(INT, INT), listOf()),
        MINIMENU_RESETORDER(listOf(), listOf()),
        MINIMENU_SETORDEREDIT(listOf(INT), listOf()),
        MINIMENU_GETORDEREDIT(listOf(), listOf(INT)),
        ...
        LOOTTRACKER_SOURCEADD(listOf(STRING, INT, INT, INT), listOf()),
        LOOTTRACKER_SOURCENAMECOUNT(listOf(), listOf(INT)),
        LOOTTRACKER_SOURCENAME(listOf(INT), listOf(STRING)),
        LOOTTRACKER_SOURCEID(listOf(STRING), listOf(INT)),
        LOOTTRACKER_SOURCECOUNT(listOf(STRING), listOf(INT)),
        ...
        LOOTTRACKER_IGNORELOOTGET(listOf(INT), listOf(STRING)),
        LOOTTRACKER_IGNORELOOTCLEAR(listOf(), listOf()),
        LOOTTRACKER_IGNORESOURCEADD(listOf(STRING), listOf()),
        LOOTTRACKER_IGNORESOURCEDEL(listOf(STRING), listOf()),
        LOOTTRACKER_IGNORESOURCECOUNT(listOf(), listOf(INT)),
        ...
        HISCORE_LOOKUP(listOf(STRING, INT), listOf()),
        HISCORE_GETRANK(listOf(STRING), listOf(INT)),
        HISCORE_GETVALUE(listOf(STRING), listOf(INT)),
        HISCORE_GETSKILLRANK(listOf(INT), listOf(INT)),
        HISCORE_GETGAMERANK(listOf(INT), listOf(INT)),
        HISCORE_GETSKILLXP(listOf(INT), listOf(INT)),
        HISCORE_GETGAMECOMPLETIONS(listOf(INT), listOf(INT)),
        HISCORE_GETOVERALLRANK(listOf(), listOf(INT)),
        HISCORE_GETOVERALLXP(listOf(), listOf(INT, INT)),
        HISCORE_GETSTATUS(listOf(), listOf(INT)),
        HISCORE_CLEAR(listOf(), listOf()),
        HISCORE_GETERROR(listOf(), listOf(STRING)),
        HISCORE_SETAPI(listOf(INT), listOf()),
        HISCORE_GETBOSSRANK(listOf(VARP), listOf(INT)),
        HISCORE_GETBOSSKILLS(listOf(VARP), listOf(INT)),
        HISCORE_GETGROUPTOTALLEVEL(listOf(), listOf(INT)),
        HISCORE_GETGROUPTOTALXP(listOf(), listOf(INT)),
        HISCORE_GETGROUPSIZE(listOf(), listOf(INT)),
        HISCORE_GETMEMBERCOUNT(listOf(), listOf(INT)),
        HISCORE_GETMEMBERLEVEL(listOf(STRING), listOf(INT)),
        HISCORE_GETMEMBERCONTRIBUTEDXP_BYNAME(listOf(STRING), listOf(INT)),
        HISCORE_GETMEMBERLEVEL_BYINDEX(listOf(INT), listOf(INT)),
        HISCORE_GETMEMBERCONTRIBUTEDXP_BYINDEX(listOf(INT), listOf(INT)),
        HISCORE_GETMEMBERNAME(listOf(INT), listOf(STRING)),
        HISCORE_GETMEMBERHISCORES(listOf(INT), listOf()),
        ;
    ...
    enum class ClientScript : Command {
        ...
        CC_SETONKEYUP,
        CC_SETONMAPPOST,
        CC_CRMVIEW_SETONUPDATED,
        CC_INPUT_SETONFOCUSCHANGE,
        CC_INPUT_SETONSUBMIT,
        IF_SETONCLICK,
        IF_SETONHOLD,
        IF_SETONRELEASE,
        IF_SETONMOUSEOVER,
