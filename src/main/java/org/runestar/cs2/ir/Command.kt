...
interface Command {
    ...
    enum class Basic(
        ...
        OVERLAYCHILD_CREATE(listOf(NEWVAR, IFTYPE, COMSUBID), listOf()),
        OVERLAYCHILD_DELETEALL(listOf(NEWVAR), listOf()),
        CC_FIND(listOf(COMPONENT, COMSUBID), listOf(BOOL), true),
        IF_FIND(listOf(COMPONENT), listOf(BOOLEAN), true),
        OVERLAY_FIND(listOf(NEWVAR), listOf(BOOL)),
        OVERLAYCHILD_FIND(listOf(INT, COMSUBID), listOf(BOOL)),
        ...
        CC_SETTRANSBOT(listOf(INT), listOf(), true),
        CC_SETFILLMODE(listOf(INT), listOf(), true),
        ...
        CC_SETMENUPRIORITY(listOf(BOOLEAN), listOf(), true),
        CC_SETONTRADINGPOSTTRANSMIT(listOf(INT), listOf(), true),
        ...
        IF_SETTRANSBOT(listOf(INT, COMPONENT), listOf()),
        IF_SETFILLMODE(listOf(INT, COMPONENT), listOf()),
        ...
        IF_SETMENUPRIORITY(listOf(BOOLEAN, COMPONENT), listOf()),
        IF_SETONTRADINGPOSTTRANSMIT(listOf(INT, COMPONENT), listOf()),
        ...
        SETMOUSECROSSSPRITE(listOf(INT, INT), listOf()),
        SETDRAWTARGETVERB(listOf(INT), listOf()),
        ...
        SETKEYINPUTMODE_COMPONENT(listOf(BOOLEAN), listOf()),
        SETKEYINPUTMODE_INTERFACE(listOf(BOOLEAN), listOf()),
        ...
        OPEN_SHOP(listOf(STRING, STRING), listOf()),
        ...
        GET_DESTINATION_TILE(listOf(), listOf(_COORD)),
        ...
        CLEAR_FRIEND_LIST_ORDERINGS(listOf(), listOf()),
        ADD_FRIEND_LIST_ORDERING_DEFAULT(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_USERNAME(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_WORLD(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_LASTWORLDCHANGE(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_ONLINE(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_ONLINE_USERNAME(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_ONLINE_LASTWORLDCHANGE(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_SAMEWORLD(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_SAMEWORLD_USERNAME(listOf(BOOLEAN), listOf()),
        ADD_FRIEND_LIST_ORDERING_SAMEWORLD_LASTWORLDCHANGE(listOf(BOOLEAN), listOf()),
        SORT_FRIEND_LIST(listOf(), listOf()),
        CLEAR_IGNORE_LIST_ORDERINGS(listOf(), listOf()),
        ADD_IGNORE_LIST_ORDERING_DEFAULT(listOf(BOOLEAN), listOf()),
        ADD_IGNORE_LIST_ORDERING_USERNAME(listOf(BOOLEAN), listOf()),
        SORT_IGNORE_LIST(listOf(), listOf()),
        CLEAR_CHANNEL_MEMBER_LIST_ORDERINGS(listOf(), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_DEFAULT(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_USERNAME(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_WORLD(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_LASTWORLDCHANGE(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_ONLINE(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_ONLINE_USERNAME(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_ONLINE_LASTWORLDCHANGE(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_SAMEWORLD(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_SAMEWORLD_USERNAME(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_SAMEWORLD_LASTWORLDCHANGE(listOf(BOOLEAN), listOf()),
        SORT_CHANNEL_MEMBER_LIST(listOf(), listOf()),
        ADD_FRIEND_LIST_ORDERING_RANK(listOf(BOOLEAN), listOf()),
        ADD_CHANNEL_MEMBER_LIST_ORDERING_RANK(listOf(BOOLEAN), listOf()),

        SET_STEAM_ACHIEVEMENT_UNLOCKED(listOf(STRING, INT, INT), listOf(INT)),
        SET_STEAM_STAT_PROGRESS(listOf(STRING, INT, INT), listOf(INT)),
        ...
        OC_SHIFTCLICKINDEX(listOf(OBJ), listOf(INT)),
        ...
        OPEN_STORE(listOf(), listOf(INT)),
        GET_STORE_STATUS(listOf(STRING, STRING), listOf()),
        ...
        OBJ_QUANTITY(listOf(), listOf(INT)),

        PLAYER_NAME(listOf(), listOf(STRING)),
        SELF_PLAYER_PATH_LENGTH(listOf(), listOf(INT)),
        SELF_PLAYER_PATH_COORD(listOf(INT), listOf(_COORD)),
        PLAYER_UID(listOf(), listOf(_PLAYER_UID)),
        SELF_PLAYER_UID(listOf(), listOf(_PLAYER_UID)),

        GET_HOVERED_TILE(listOf(), listOf(_COORD)),

        HIGHLIGHT_NPC_CONFIGURE_CATEGORY(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        HIGHLIGHT_NPCTYPE_CONFIGURE_CATEGORY(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        HIGHLIGHT_LOC_CONFIGURE_CATEGORY(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        HIGHLIGHT_LOCTYPE_CONFIGURE_CATEGORY(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        HIGHLIGHT_OBJ_CONFIGURE_CATEGORY(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        HIGHLIGHT_OBJTYPE_CONFIGURE_CATEGORY(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        HIGHLIGHT_PLAYER_CONFIGURE_CATEGORY(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        HIGHLIGHT_TILE_CONFIGURE_CATEGORY(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        OVERLAY_CREATE_NPC(listOf(INT, INT, INT, INT, INT), listOf(NEWVAR)),
        OVERLAY_CREATE_LOC(listOf(INT, INT, INT, INT, INT), listOf(NEWVAR)),
        OVERLAY_CREATE_OBJ(listOf(INT, INT, INT, INT, INT), listOf(NEWVAR)),
        OVERLAY_CREATE_PLAYER(listOf(INT, INT, INT, INT, INT), listOf(NEWVAR)),
        OVERLAY_CREATE_TILE(listOf(_COORD, INT, INT, INT, INT, INT), listOf(NEWVAR)),
        _7205(listOf(), listOf(INT)),
        _7206(listOf(), listOf(INT)),
        _7207(listOf(), listOf(INT)),
        _7208(listOf(), listOf(INT)),
        _7209(listOf(), listOf(INT)),
        OVERLAY_DELETE_NPC(listOf(INT), listOf()),
        OVERLAY_DELETE_LOC(listOf(INT), listOf()),
        OVERLAY_DELETE_OBJ(listOf(INT), listOf()),
        OVERLAY_DELETE_PLAYER(listOf(INT), listOf()),
        OVERLAY_DELETE_TILE(listOf(_COORD, INT), listOf()),
