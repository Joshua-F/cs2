...
interface Command {
    ...
    enum class Basic(
        ...
        CC_SETTRANSTOP(listOf(TRANS), listOf(), true),
        ...
        CC_GETTRANSTOP(listOf(), listOf(TRANS), true),
        ...
        IF_SETTRANSTOP(listOf(TRANS, COMPONENT), listOf()),
        ...
        IF_GETTRANSTOP(listOf(COMPONENT), listOf(TRANS)),
        ...
        SETSETTING(listOf(INT, INT), listOf()),
        GETSETTING(listOf(INT), listOf(INT)),
        ...
        TIME_TO_LOGOUT(listOf(), listOf(INT)),
        TOGGLE_IDLE_NOTIFIER(listOf(), listOf()),
        ...
        SETINTERFACESCALING(listOf(INT), listOf()),
        RESETINTERFACESCALING(listOf(), listOf()),
        ...
        _7020(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        _7025(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        _7030(listOf(INT, COLOUR, INT, INT, INT), listOf()),
        ...
        _7035(listOf(INT, COLOUR, INT, INT, INT), listOf()),
