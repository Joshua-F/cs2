...
const val OVERLAYCHILD_CREATE = 103
const val OVERLAYCHILD_DELETEALL = 104
const val CC_FIND = 200
const val IF_FIND = 201
const val OVERLAY_FIND = 202
const val OVERLAYCHILD_FIND = 203
...
const val CC_SETDRAGRENDERBEHAVIOUR = 1302
...
const val CC_SETMENUPRIORITY = 1308
const val CC_SETONTRADINGPOSTTRANSMIT = 1309
...
const val CC_GETTRANSBOT = 1610
const val CC_GETCOLOUR = 1611
const val CC_GETFILLCOLOUR = 1612
const val CC_GETFILLMODE = 1613
...
const val IF_SETDRAGRENDERBEHAVIOUR = 2302
...
const val IF_SETMENUPRIORITY = 2308
const val IF_SETONTRADINGPOSTTRANSMIT = 2309
...
const val IF_GETTRANSBOT = 2610
const val IF_GETCOLOUR = 2611
const val IF_GETFILLCOLOUR = 2612
const val IF_GETFILLMODE = 2613
...
const val SETOCULUSSPEED = 3129
const val SETMOUSECROSSSPRITE = 3130
const val SETDRAWTARGETVERB = 3131
...
const val SETMUTETITLESCREEN = 3146
const val GETMUTETITLESCREEN = 3147
const val SETTERMSANDPRIVACY = 3148
const val GETTERMSANDPRIVACY = 3149
const val ELIGIBLE_FOR_TRIAL_PURCHASE = 3150
const val ELIGIBLE_FOR_INTRODUCTORY_PRICE = 3151
const val GET_MEMBERSHIP_ELIGIBILITY_LOADING_STATUS = 3152
const val GET_CLIENT_LOAD_PERCENT = 3153
const val GET_CACHE_LOAD_PERCENT = 3154
const val PURCHASE_SHOP_ITEM = 3155
const val REQUEST_SHOP_DATA = 3156
const val OPEN_SHOP = 3157
const val GET_PURCHASE_SHOP_ITEM_STATUS = 3158
const val GET_REQUEST_SHOP_DATA_STATUS = 3159
const val GET_SHOP_CATEGORY_COUNT = 3160
const val GET_SHOP_CATEGORY_ID = 3161
const val GET_SHOP_CATEGORY_INDEX_BY_ID = 3162
const val GET_SHOP_CATEGORY_INDEX_BY_NAME = 3163
const val GET_SHOP_CATEGORY_DESCRIPTION = 3164
const val GET_SHOP_CATEGORY_PRODUCT_COUNT = 3165
const val IS_SHOP_PRODUCT_AVAILABLE = 3166
const val IS_SHOP_PRODUCT_RECOMMENDED = 3167
const val GET_SHOP_PRODUCT_DETAILS = 3168
const val OPEN_NOTIFICATION_SETTINGS = 3169
const val SEND_NOTIFICATION = 3170
const val SEND_GROUPED_NOTIFICATION = 3171
const val CANCEL_NOTIFICATION = 3172
const val IS_NOTIFICATION_SCHEDULED = 3173
const val _3174 = 3174
const val ARE_NOTIFICATIONS_ENABLED = 3175
const val _3176 = 3176
const val INIT_MOBILE_ANALYTICS_SERVICE = 3177
const val SEND_MOBILE_ANALYTICS_EVENT = 3178
const val INIT_MOBILE_ATTRIBUTION_SERVICE = 3179
const val SEND_MOBILE_ATTRIBUTION_EVENT = 3180
...
const val SETPREFERENCE = 3209
const val GETPREFERENCE = 3210
...
const val GETTIMETOLOGOUT = 3328
const val TOGGLELOGOUTNOTIFIER = 3329
const val GET_DESTINATION_TILE = 3330
...
const val CLEAR_FRIEND_LIST_ORDERINGS = 3628
const val ADD_FRIEND_LIST_ORDERING_DEFAULT = 3629
const val ADD_FRIEND_LIST_ORDERING_USERNAME = 3630
const val ADD_FRIEND_LIST_ORDERING_WORLD = 3631
const val ADD_FRIEND_LIST_ORDERING_LASTWORLDCHANGE = 3632
const val ADD_FRIEND_LIST_ORDERING_ONLINE = 3633
const val ADD_FRIEND_LIST_ORDERING_ONLINE_USERNAME = 3634
const val ADD_FRIEND_LIST_ORDERING_ONLINE_LASTWORLDCHANGE = 3635
const val ADD_FRIEND_LIST_ORDERING_SAMEWORLD = 3636
const val ADD_FRIEND_LIST_ORDERING_SAMEWORLD_USERNAME = 3637
const val ADD_FRIEND_LIST_ORDERING_SAMEWORLD_LASTWORLDCHANGE = 3638
const val SORT_FRIEND_LIST = 3639
const val CLEAR_IGNORE_LIST_ORDERINGS = 3640
const val ADD_IGNORE_LIST_ORDERING_DEFAULT = 3641
const val ADD_IGNORE_LIST_ORDERING_USERNAME = 3642
const val SORT_IGNORE_LIST = 3643
const val CLEAR_CHANNEL_MEMBER_LIST_ORDERINGS = 3644
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_DEFAULT = 3645
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_USERNAME = 3646
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_WORLD = 3647
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_LASTWORLDCHANGE = 3648
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_ONLINE = 3649
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_ONLINE_USERNAME = 3650
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_ONLINE_LASTWORLDCHANGE = 3651
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_SAMEWORLD = 3652
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_SAMEWORLD_USERNAME = 3653
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_SAMEWORLD_LASTWORLDCHANGE = 3654
const val SORT_CHANNEL_MEMBER_LIST = 3655
const val ADD_FRIEND_LIST_ORDERING_RANK = 3656
const val ADD_CHANNEL_MEMBER_LIST_ORDERING_RANK = 3657
const val SET_STEAM_ACHIEVEMENT_UNLOCKED = 3700
const val SET_STEAM_STAT_PROGRESS = 3701
...
const val OC_FINDRESTART = 4212
const val OC_SHIFTCLICKINDEX = 4213
...
const val SETMINASPECTRATIO = 5310
const val SETWINDOWSIZE = 5311
const val SETWINDOWALWAYSONTOP = 5312
...
const val OPEN_STORE = 5632
const val GET_STORE_STATUS = 5633
...
const val SETUIZOOM = 6210
const val RESETUIZOOM = 6212
...
const val WORLDLIST_GETBYINDEX = 6511
...
const val WORLDMAP_GETSOURCEPOSITION = 6615
const val WORLDMAP_GETCURRENTMAP = 6616
const val WORLDMAP_GETDISPLAYCOORD = 6617
const val WORLDMAP_GETSOURCECOORD = 6618
const val WORLDMAP_SETMAP_COORD = 6619
const val WORLDMAP_SETMAP_COORD_OVERRIDE = 6620
const val WORLDMAP_COORDINMAP = 6621
const val WORLDMAP_GETSIZE = 6622
const val WORLDMAP_GETMAP = 6623
const val WORLDMAP_SETFLASHLOOPS = 6624
const val WORLDMAP_SETFLASHLOOPS_DEFAULT = 6625
const val WORLDMAP_SETFLASHTICS = 6626
const val WORLDMAP_SETFLASHTICS_DEFAULT = 6627
...
const val WORLDMAP_FINDNEARESTELEMENT = 6638
...
const val MAPELEMENT_TYPE = 6697
const val MAPELEMENT_DISPLAYCOORD = 6698
const val MAPELEMENT_SOURCECOORD = 6699
...
const val OBJ_QUANTITY = 6853
const val PLAYER_NAME = 6900
const val SELF_PLAYER_PATH_LENGTH = 6902
const val SELF_PLAYER_PATH_COORD = 6903
const val PLAYER_UID = 6904
const val SELF_PLAYER_UID = 6905
const val GET_HOVERED_TILE = 6950
const val HIGHLIGHT_NPC_CONFIGURE_CATEGORY = 7000
...
const val HIGHLIGHT_NPCTYPE_CONFIGURE_CATEGORY = 7005
...
const val HIGHLIGHT_LOC_CONFIGURE_CATEGORY = 7010
...
const val HIGHLIGHT_LOCTYPE_CONFIGURE_CATEGORY = 7015
...
const val HIGHLIGHT_OBJ_CONFIGURE_CATEGORY = 7020
...
const val HIGHLIGHT_OBJTYPE_CONFIGURE_CATEGORY = 7025
...
const val HIGHLIGHT_PLAYER_CONFIGURE_CATEGORY = 7030
...
const val HIGHLIGHT_TILE_CONFIGURE_CATEGORY = 7035
...
const val GET_ACTIVE_MINIMENU_ENTRY_COORD = 7106
const val _7107 = 7107
const val IS_MINIMENU_OPEN = 7108
...
const val OVERLAY_CREATE_NPC = 7200
const val OVERLAY_CREATE_LOC = 7201
const val OVERLAY_CREATE_OBJ = 7202
const val OVERLAY_CREATE_PLAYER = 7203
const val OVERLAY_CREATE_TILE = 7204
const val _7205 = 7205
const val _7206 = 7206
const val _7207 = 7207
const val _7208 = 7208
const val _7209 = 7209
const val OVERLAY_DELETE_NPC = 7210
const val OVERLAY_DELETE_LOC = 7211
const val OVERLAY_DELETE_OBJ = 7212
const val OVERLAY_DELETE_PLAYER = 7213
const val OVERLAY_DELETE_TILE = 7214
const val SETMINIMAPLOCK = 7250
const val SET_MINIMAP_ZOOM = 7252
